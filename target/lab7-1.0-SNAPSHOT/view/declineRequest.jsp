...
<html>
 ...
 <body>
    <h2><fmt:message key="command.declineRequest"/></h2>
 
    <p style="color: red;">${errorString}</p>

    <form action="${pageContext.request.contextPath}/?command=declineRequest" method="post">
        <p><fmt:message key="decline.id"/>
            <input type="text" name="req_id" /></p>
    </form>
